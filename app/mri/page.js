...
const CLASS_META = {
  ...
  MildOrVeryMildDemented: { label: "Mild / Very Mild Dementia", color: "#f59e0b" },
  ModerateDemented:       { label: "Moderate Dementia",         color: "#ef4444" },
};
const CLASS_ORDER = ["NonDemented", "MildOrVeryMildDemented", "ModerateDemented"];
      ...
      <div style={{ flex: 1, padding: "40px clamp(18px, 4vw, 44px)", maxWidth: "900px", width: "100%", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: "0.88rem", color: "#92400e", lineHeight: 1.5 }}>
            This tool is intended for screening purposes. Results are not a clinical diagnosis. Always consult a qualified clinician before making any medical decisions.
          </p>
        </div>
